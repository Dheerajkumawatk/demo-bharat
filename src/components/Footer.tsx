  ...
  return (
    <footer>
      ...
      <div className="bg-navy-dark text-white/80">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-7 sm:grid-cols-2 sm:px-6 lg:grid-cols-[1.2fr_1fr_1fr_1fr] lg:px-8">
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed">
              {site.role}, ग्राम पंचायत {site.village}। सशक्त पंचायत, समृद्ध गांव, खुशहाल भविष्य के संकल्प के साथ आपकी सेवा में।
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="transition-colors hover:text-saffron">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-white/10 px-4 py-5 text-center text-xs text-white/60 sm:px-6">
          © 2026, सर्वाधिकार सुरक्षित — {site.name}
        </div>
      </div>
    </footer>
  );
